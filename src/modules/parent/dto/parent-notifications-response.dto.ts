...
export class ParentNotificationItemDto {
  ...
  @ApiProperty({
    example: { type: 'announcement', announcementId: '12', route: 'announcements' },
    type: 'object',
...
export class ParentNotificationsResponseDto {
  @ApiProperty({ type: [ParentNotificationItemDto] })
  notifications!: ParentNotificationItemDto[];
}
