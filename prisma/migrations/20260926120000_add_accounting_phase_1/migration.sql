...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'public' AND table_name = 'persons' AND column_name = 'account_id'
  ) THEN
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_register_types" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_register" (
    "id" SERIAL NOT NULL,
    "description" TEXT,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_purchase" (
    "id" SERIAL NOT NULL,
    "accounting_register_id" INTEGER NOT NULL,
    "nb" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_sales_return" (
    "id" SERIAL NOT NULL,
    "accounting_register_id" INTEGER NOT NULL,
    "nb" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_purchase_return" (
    "id" SERIAL NOT NULL,
    "accounting_register_id" INTEGER NOT NULL,
    "nb" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_invoice_details" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_registration_package" (
    "id" SERIAL NOT NULL,
    "name" VARCHAR(255) NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_registration_package_items" (
    "id" SERIAL NOT NULL,
    "item_id" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "accounting_registration_package_classes" (
    "id" SERIAL NOT NULL,
    "accounting_registration_package_id" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "accounting_register_types_name_key" ON "accounting_register_types"("name");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "accounts_code_key" ON "accounts"("code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_register_accounting_register_type_id_idx" ON "accounting_register"("accounting_register_type_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_register_school_id_idx" ON "accounting_register"("school_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_daily_account_id_idx" ON "accounting_daily"("account_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_daily_accounting_register_id_idx" ON "accounting_daily"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_receipts_accounting_register_id_idx" ON "accounting_receipts"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_payments_accounting_register_id_idx" ON "accounting_payments"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_sales_accounting_register_id_idx" ON "accounting_sales"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_purchase_accounting_register_id_idx" ON "accounting_purchase"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_sales_return_accounting_register_id_idx" ON "accounting_sales_return"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_purchase_return_accounting_register_id_idx" ON "accounting_purchase_return"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_invoice_accounting_register_id_idx" ON "accounting_invoice"("accounting_register_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_invoice_details_invoice_id_idx" ON "accounting_invoice_details"("invoice_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_invoice_details_item_id_idx" ON "accounting_invoice_details"("item_id");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "item_types_name_key" ON "item_types"("name");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "items_school_id_idx" ON "items"("school_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "items_item_type_id_idx" ON "items"("item_type_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_registration_package_year_id_idx" ON "accounting_registration_package"("year_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_registration_package_items_item_id_idx" ON "accounting_registration_package_items"("item_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_registration_package_items_accounting_registrati_idx" ON "accounting_registration_package_items"("accounting_registration_package_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_registration_package_classes_accounting_registra_idx" ON "accounting_registration_package_classes"("accounting_registration_package_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "accounting_registration_package_classes_class_id_idx" ON "accounting_registration_package_classes"("class_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "installment_account_id_idx" ON "installment"("account_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "installment_receipt_id_idx" ON "installment"("receipt_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "installment_year_id_idx" ON "installment"("year_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "persons_account_id_idx" ON "persons"("account_id");

-- AddForeignKey
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'persons_account_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_register_accounting_register_type_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_register_school_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_daily_account_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_daily_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_receipts_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_payments_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_sales_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_purchase_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_sales_return_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_purchase_return_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_invoice_accounting_register_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_invoice_details_invoice_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_invoice_details_item_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'items_school_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'items_item_type_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_registration_package_year_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_registration_package_items_item_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_registration_package_items_accounting_registrat_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_registration_package_classes_accounting_registr_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'accounting_registration_package_classes_class_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'installment_account_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'installment_receipt_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'installment_year_id_fkey'
  ) THEN
